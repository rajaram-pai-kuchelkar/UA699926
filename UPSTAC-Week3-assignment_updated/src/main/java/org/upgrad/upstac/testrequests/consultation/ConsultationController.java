...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        List<TestRequest> testRequestsLabTestCompleted = testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED);

        if (testRequestsLabTestCompleted!= null)
            return testRequestsLabTestCompleted;
        else
            throw new AppException("Completed Lab Results not found");
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        List<TestRequest> testRequestsAssignedToDoctor = testRequestQueryService.findByDoctor(doctor);
        if (testRequestsAssignedToDoctor != null)
            return testRequestsAssignedToDoctor;
        else
            throw new AppException("TEST REQUESTS NOT ASSIGNED");
